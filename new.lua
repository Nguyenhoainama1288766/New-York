...
function Update:Window(text,logo,keybind)
	...
	Hubb.Text = "Version 2.0.0 By Duy Mod Game"
...
local Library = Update:Window("DUY MOD GAME","2.0",Enum.KeyCode.RightControl);
...
Main:Toggle("Cày Cấp độ",_G.Setting_table.AutoFarm,function(vu)
	Auto_Farm = vu
	Auto_Fast_Farm = vu
...
Main:Toggle("Farm 600 Mastery Mele",_G.Setting_table.MasMelee,function(vu)
	MasMelee = vu
...
Main:Dropdown("Chọn Kiểu Farm",fast,function(vu)
...
Main:Dropdown("Tốc Độ Đánh",SFast,function(vu)
...
Main:Toggle("Auto Grab Chest Mirage Island",_G.Setting_table.AutoChestMirage,function(vu)
 ...
 Kill_Cake_Monster_ST = Main:Label("")
	...
	Main:Toggle("Tự Động Đánh Katakuri",_G.Setting_table.Auto_Spikey_Trident,function(vu)
 ...
 Elite_Hunter_Status = Main:Label("")
	...
	Main:Toggle("Tự Động Farm Katakuri V2",_G.Setting_table.Prince2,function(vu)
		Prince2 = vu
		_G.Setting_table.Prince2 = vu
		Update_Setting(getgenv()['MyName'])
	end)

	Main:Toggle("Hop",_G.Setting_table.Hop,function(vu)
		Hop = vu
	...
	Main:Toggle("Tự Động Farm Mastery Trái",_G.Setting_table.Farm_Fruit,function(vu)
		Auto_Farm_Fruit = vu
    ...
    MinHealth = 20
	Main:Slider("Tốc Độ Chiêu",1,100,20,function(vu)
		MinHealth = vu
		_G.Setting_table.MinHealth = vu
		Update_Setting(getgenv()['MyName'])
	end)

	Main:Slider("Tốc Độ Chiêu",1,5000,1000,function(vu)
...
spawn(function()
	...
	Main:Toggle("Chiêu F",_G.Setting_table.Skill_F,function(vu)
		SkillF = vu
...
Shop:Button("Mua God Human",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
end)
...
Raid:Toggle("Raid Hop",_G.Setting_table.Auto_Raid_Hop,function(vu)
	Auto_Raid = vu
	_G.Setting_table.Auto_Raid_Hop = vu
	Update_Setting(getgenv()['MyName'])
end)

Raid:Toggle("Giết Quái Raid[Click]",_G.Setting_table.Auto_Raid,function(vu)
	Auto_Raid = vu
...
Raid:Seperator("Boss Law")
	

	Raid:Toggle("Tự Động Đánh Boss Law",_G.Setting_table.Raw,function(vu)
		Auto_Raw = vu
...
Raid:Toggle("ESP Trái Spawm",_G.Setting_table.RealFruitESP,function(vu)
	RealFruitESP = vu
	_G.Setting_table.RealFruitESP = vu
	UpdateRealFruitChams()
end)

Raid:Toggle("ESP Trái",_G.Setting_table.DevilFruitESP,function(vu)
	DevilFruitESP = vu
